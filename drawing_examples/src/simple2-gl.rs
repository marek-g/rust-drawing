...
type DrawingBackend = drawing_gl::GlBackend;
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let drawing_backend_rc = Rc::new(RefCell::new(DrawingBackend::new().unwrap()));
    ...
    setup_window(&gl_window_rc, &drawing_backend_rc);
...
fn setup_window(gl_window_rc: &Rc<RefCell<GlWindow>>, device_rc: &Rc<RefCell<GlDevice>>) {
